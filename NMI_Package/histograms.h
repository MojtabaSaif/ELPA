...
template <typename type>
 int log_histogram(std::deque<type> &c, ostream & out, int number_of_bins) {		// c is the set od data, min is the lower bound, max is the upper one
...
template <typename type>
static int not_norm_histogram (vector<type> &c, ostream & out, int number_of_bins, double b1, double b2) {
